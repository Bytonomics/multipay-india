...
type SubscriptionMeta struct {
	...
	SessionIDExpiry     string   `json:"session_id_expiry,omitempty" validate:"omitempty,maxLength=64"`
}
...
type SubscriptionBankDetails struct {
	AccountHolderName string `json:"account_holder_name,omitempty" validate:"omitempty,maxLength=200"`
	AccountNumber     string `json:"account_number,omitempty" validate:"omitempty,maxLength=50"`
	IFSC              string `json:"ifsc,omitempty" validate:"omitempty,maxLength=20"`
	BankCode          string `json:"bank_code,omitempty" validate:"omitempty,maxLength=20"`
	AccountType       string `json:"account_type,omitempty" validate:"omitempty,maxLength=20"`
}
...
type SubscriptionAddon struct {
	Name        string      `json:"name,omitempty" validate:"omitempty,maxLength=250"`
	AmountMinor AmountMinor `json:"amount_minor,omitempty" validate:"omitempty,gte=0"`
	Currency    Currency    `json:"currency,omitempty" validate:"omitempty,iso4217"`
	Quantity    int64       `json:"quantity,omitempty" validate:"omitempty,gte=1"`
}
